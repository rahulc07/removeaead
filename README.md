## Description
This is a very simple kernel module that disablas aead crypto in kernels where algif\_aead is built-in. You do not need this if algif\_aead is built as an external module.

This prevents CVE-2026-31431 exploits and secures machines until updated kernels are available.
...
A few pre-built rpms can be found here:
